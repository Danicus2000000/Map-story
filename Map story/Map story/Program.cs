...
namespace Map_story
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            map_parts[8] = "The shopkeeper Stares at you hoping you'll Buy Something, best get moving before he tries to sell everything to us";
            ...
            while (true)//name confimation loop
                ...
                while (true)
                {
                        ...
                        while (true)
                        {
                            while (true)
                            {
                                ...
                                else
                                {
                                    ...
                                    Console.WriteLine("Press Enter to re - issue your command!");
                                    Console.ReadLine();
                                }
                            }
                            if ((choice == "RUN") || (choice == "R") || (choice=="3") && (run_fail_result != 7) )
                            {
                                ...
                                {
                                    Console.WriteLine("{0}, you and your team run from the monster like disgraceful cowards. Back to the previous tile!", name);
                                    run = true;
                                    break;
                                }
                            }
                            ...
                            else if ((choice == "BAG") || (choice == "B") || (choice=="2"))
                            {
                                while (true)
                                {
                                    ...
                                    Console.WriteLine("Press enter to Go back or type the first letter of the potion's name to use it!");
                                    potion_choice = Console.ReadLine().ToUpper(); //continue from here
                                    if ((potion_choice == "H") || (potion_choice == "HEALTH POTION") || (potion_choice=="HEALTH POTIONS"))
                                    {
                                        if (max_hp == hp)
                                        {
                                    ...
                                    else if ((potion_choice == "M") || (potion_choice == "MAX HP POTION") || (potion_choice=="MAX HP POTIONS"))
                                    {
                                        if (max_hp == hp)
                                        {
                                            Console.WriteLine("You already have max health you imbecile!!");
                                            Console.WriteLine("Press Enter to continue my glorious leader!");
                                            Console.ReadLine();
                                        }
                                    ...
                                    else if ((potion_choice == "L") || (potion_choice == "LEVEL UP POTION") || (potion_choice=="LEVEL UP POTIONS"))
                                    {
                                        if (level_up_potions >= 1)
                                        {
                                            player_level++;
                            ...
                            if ((choice == "FIGHT") || (choice == "F") || run_fail_result==7 || potion_used==true || choice=="1")
                            {
                                if (potion_used != true || choice=="FIGHT" || choice=="F" || run_fail_result!=7 || choice=="1")
                                {
                                    ...
                                    Console.WriteLine("You attack the {0} and do {1} damage {2}", enemy_names[result_choice], player_attack, name);
                                    ...
                                    if (enemy_hp <= 0)
                                    {
                                        ...
                                        Console.WriteLine("You add this enemy to your kill list, its description reads as follows\n{0}", enemy_descriptions[result_choice]);
                                        kills++;
                                        if (kills % 3 == 0)
                                        {
                                            Console.WriteLine("Congratulations {0} You have leveled up to level {1} your attack and hp has increased, plus your hp has been restored!", name, player_level);
                                            player_level++;
                                            max_hp += 2;
                                            hp = max_hp;
                                            if (kills % 6 == 0)
                                ...
                                Console.WriteLine("{0} is preparing to attack!", enemy_names[result_choice]);
                    ...
                    if (mapspace == 9)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if ((choice == "YES") || (choice == "YE") || (choice == "YEET") || (choice == "YEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"))
                            {
                                while (true)
                                {
                                    Console.WriteLine("Health Potions: 35 Gold");
                                    Console.WriteLine("Max Health Potions: 50 Gold");
                                    Console.WriteLine("Level Up potions: 75 Gold");
                                    Console.WriteLine("Your have {0} gold", gold);
                                    Console.WriteLine("Enter the first letter of the potion to purchase it, or quit/q to quit");
                                    choice = Console.ReadLine().ToUpper();
                                    if ((choice == "H") || (choice == "HEALTH POTION") || (choice == "HEALTH POTIONS"))
                                    {
                                        if (gold >= 35)
                                        {
                                            gold -= 35;
                                    ...
                                    else if ((choice == "M") || (choice == "MAX HEALTH POTION") || (choice == "MAX HEALTH POTIONS"))
                                    {
                                        if (gold >= 50)
                                        {
                                            gold -= 50;
                                    ...
                                    else if ((choice == "L") || (choice == "LEVEL UP POTION") || (choice == "LEVEL UP POTIONS"))
                                    {
                                        if (gold >= 100)
                                        {
                                            gold -= 100;
                            ...
                            else if ((choice == "Q") || (choice == "QUIT") || (choice=="NO") || (choice=="NAH") || (choice=="NA") || (choice=="NO THANKS") || (choice=="NOPE"))
                            {
                                ...
                                Console.WriteLine("Press Enter to return {0}!", name);
                                Console.ReadLine();
                                break;
                            }
                            else
                            {
                                Console.WriteLine("The shopkeeper looks on, extremely confused at your babbling!");
                            }
                    ...
                    {
                        Console.WriteLine("{0}, what the hell are you on about! Tell your team where to go you !", name);
                    }
                    else//if its not valid move
                    {
                        Console.WriteLine("{0}!!! That goes into the unmapped mystic lands! We can't breathe there, the air is too thiccccccc! We must stick in the mapped zone!", name);
                    }
                ...
                {
                    Console.WriteLine("Goodbye {0} you were a truly amazing hero!",name);
                    if (hp <= 0)
                    {
